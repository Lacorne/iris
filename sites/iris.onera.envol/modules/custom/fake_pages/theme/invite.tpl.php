...
.fake-header:after {
  ...
  height: 196px;
  border-top: solid 24px #303133;
  background: -webkit-linear-gradient(top, #fff, #fff 92px, #199cdb 92px);
  background: -moz-linear-gradient(top, #fff, #fff 92px, #199cdb 92px);
  background: -o-linear-gradient(top, #fff, #fff 92px, #199cdb 92px);
  background: -ms-linear-gradient(top, #fff, #fff 92px, #199cdb 92px);
  background: linear-gradient(to bottom, #fff, #fff 92px, #199cdb 92px);
}
.fake-footer {
  position: absolute;
  bottom: 0;
