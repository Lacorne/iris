...
/**
 * @file
 * Override of the salonult maintenance page.
 *
 * This is an override of the salonult maintenance page. Used for themesalon and
 * Minnelli, this file should not be moved or modified since the installation
 * and update pages depend on this file.
 *
 * This mirrors closely page.tpl.php for themesalon in order to share the same
 * styles.
 */
