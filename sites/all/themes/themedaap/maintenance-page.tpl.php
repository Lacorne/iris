...
/**
 * @file
 * Override of the daapult maintenance page.
 *
 * This is an override of the daapult maintenance page. Used for themedaap and
 * Minnelli, this file should not be moved or modified since the installation
 * and update pages depend on this file.
 *
 * This mirrors closely page.tpl.php for themedaap in order to share the same
 * styles.
 */
