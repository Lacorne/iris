...
/**
 * @file
 * Override of the dmaeult maintenance page.
 *
 * This is an override of the dmaeult maintenance page. Used for themedmae and
 * Minnelli, this file should not be moved or modified since the installation
 * and update pages depend on this file.
 *
 * This mirrors closely page.tpl.php for themedmae in order to share the same
 * styles.
 */
