...
#wrapper #container #center .right-corner .left-corner { padding-top: 25px; }
</style>' 
; } ?>
    <?php print $scripts ?>
    <style type="text/css" media="print">@import "<?php print base_path() . path_to_theme() ?>/print.css";
</style>
<!--[if lt IE 7]>
      ...
      <div id="squeeze">
        <div class="right-corner">
          <div class="left-corner">
            ...
            <?php print $content ?> <span class="clear"></span> <?php print $feed_icons ?>
