...
/**
 * @file
 * Override of the dtimult maintenance page.
 *
 * This is an override of the dtimult maintenance page. Used for themedtim and
 * Minnelli, this file should not be moved or modified since the installation
 * and update pages depend on this file.
 *
 * This mirrors closely page.tpl.php for themedtim in order to share the same
 * styles.
 */
