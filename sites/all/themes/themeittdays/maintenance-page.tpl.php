...
/**
 * @file
 * Override of the ittdaysult maintenance page.
 *
 * This is an override of the ittdaysult maintenance page. Used for themeittdays and
 * Minnelli, this file should not be moved or modified since the installation
 * and update pages depend on this file.
 *
 * This mirrors closely page.tpl.php for themeittdays in order to share the same
 * styles.
 */
